...
def smart_chunk(
    ...
    for tid in token_ids:
        try:
            ...
            # A single un-detokenizable token just doesn't advance the offset;
            # boundaries stay usable. Trace rather than swallow silently.
            _logger.debug("detokenize failed for token %s: %s", tid, e)
